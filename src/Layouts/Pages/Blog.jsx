    ...
    <div className="max-w-3xl px-6 py-16 mx-auto space-y-12 ">
      <article className="space-y-8 dark:bg-gray-100 dark:text-gray-900">
        <div className="space-y-6">
          ...
          <div className="flex items-center -mx-4 overflow-x-auto overflow-y-hidden sm:justify-staet flex-nowrap dark:bg-gray-100 dark:text-gray-800">
            <Link
              to=""
              ...
              } rounded-t-lg  dark:text-gray-950`}
            >
              <svg
